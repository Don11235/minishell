...
SRC = ft_lstadd_back.c ft_lstnew.c ft_split.c ft_strdup.c ft_strjoin_with.c ft_strlcpy.c ft_strlen.c \
	  ...
	  removing_quote_marks_functions.c expansion_inner_functions.c tokenization.c resplitting.c removing_quote.c execution.c \
	  check_command.c sys_error.c env_to_array.c setup_pipe.c print_error_1.c handle_redirections.c ft_putstr_fd.c execute_builtin.c \
	  ...
	  free_list.c free_cmd_list.c free_env.c ft_split_whitespace.c free_hd_parts.c wait_for_child.c prepare_heredocs.c \
	  reset_all_heredoc_fds.c reset_heredoc_fd.c handle_pipe_fds.c
all :
